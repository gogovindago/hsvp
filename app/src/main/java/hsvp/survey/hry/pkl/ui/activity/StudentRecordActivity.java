...
import hsvp.survey.hry.pkl.adapter.StudentRecordAdapter;
...
import hsvp.survey.hry.pkl.databinding.ActivityStudentRecordBinding;
...
public class    StudentRecordActivity extends BaseActivity implements GetAllnodalOfficerStudentData_interface, StudentRecordAdapter.ItemListener {
    ActivityStudentRecordBinding binding;
    GridLayoutManager manager;
    String COllegeID, token, User_Id, title,schemeId, NodalOfficreId, userGender;
    private List<StudentListUnderNodalOfficerResponse.Datum> arrayList = new ArrayList<StudentListUnderNodalOfficerResponse.Datum>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_student_record);
        ...
        binding.simpleSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if (GlobalClass.isNetworkConnected(StudentRecordActivity.this)) {
                    WebAPiCall aPiCall = new WebAPiCall();
                    aPiCall.allnodalOfficerStudent_listMethod(StudentRecordActivity.this, "Bearer " + token, User_Id, schemeId, binding.simpleSwipeRefreshLayout,StudentRecordActivity.this);

                } else {
                    Toast.makeText(StudentRecordActivity.this, GlobalClass.nointernet, Toast.LENGTH_LONG).show();
    ...
    public void initData() {
        ...
        binding.toolbar.tvToolbarTitle.setText("Student Activity Record List");
    ...
    @Override
    public void GetAllStudentListUnderNodalOfficerData(List<StudentListUnderNodalOfficerResponse.Datum> list) {
        ...
        if (list == null) {
            ...
            studentRecordAdapter = new StudentRecordAdapter(this, (ArrayList) arrayList, schemeId,title, this);
    ...
    @Override
    public void onItemClick(StudentListUnderNodalOfficerResponse.Datum item, int currposition) {
