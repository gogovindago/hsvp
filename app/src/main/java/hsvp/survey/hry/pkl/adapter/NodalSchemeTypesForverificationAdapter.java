...
public class NodalSchemeTypesForverificationAdapter extends RecyclerView.Adapter<NodalSchemeTypesForverificationAdapter.ViewHolder> {
    ...
    public NodalSchemeTypesForverificationAdapter(Context context, List<OptionDataModel> values, ItemListener itemListener) {
...
//            }
    ...
    @Override
    public NodalSchemeTypesForverificationAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
