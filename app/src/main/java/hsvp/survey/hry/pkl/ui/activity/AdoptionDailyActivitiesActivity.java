...
import hsvp.survey.hry.pkl.databinding.ActivityAdoptionDailyActivitiesBinding;
...
public class AdoptionDailyActivitiesActivity extends BaseActivity {
    ActivityAdoptionDailyActivitiesBinding binding;
    String ImageDate, Longitude, Latitude, currentDateandTime, time, TypeOfVisit="PhysicalVsit",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_adoption_daily_activities);
        ...
        btnRadiogroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int checkedId) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(AdoptionDailyActivitiesActivity.this, checkedRadioButton.getText(), Toast.LENGTH_SHORT).show();
                }
    ...
    private void checkGPSStatus() {
        ...
        if (!gps_enabled && !network_enabled) {
            AlertDialog.Builder dialog = new AlertDialog.Builder(AdoptionDailyActivitiesActivity.this);
    ...
    PermissionListener permissionListener = new PermissionListener() {
        ...
        public void onPermissionDenied(ArrayList<String> deniedPermissions) {
            checkpermissions(AdoptionDailyActivitiesActivity.this);
...
//                        break;
    ...
    public void initData() {
        binding.toolbar.tvToolbarTitle.setText("Scheme B Daily Activity");
        ...
        try {
            ...
            takecarenodalOfficerId = CSPreferences.readString(this, "adoptednodalOfficerId");
    ...
    public void initListeners() {
        ...
        binding.btnAdoptionsubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
...
longitude*/
                    ...
                    String problemfaced = binding.edtprobleminlib.getText().toString().trim();
...
Document*/
                    try {
                       ...
                       // RequestBody uplodingTime = RequestBody.create(MediaType.parse("multipart/form-data"), "11:10");
                        ...
                        if (GlobalClass.isNetworkConnected(AdoptionDailyActivitiesActivity.this)) {
                            WebAPiCall webapiCall = new WebAPiCall();
                            webapiCall.adoptionStep2DataMethod(AdoptionDailyActivitiesActivity.this, AdoptionDailyActivitiesActivity.this, "Bearer " + token,
                                    StudentId,
                            ...
                            Toast.makeText(AdoptionDailyActivitiesActivity.this, GlobalClass.nointernet, Toast.LENGTH_LONG).show();
                        }
        ...
        binding.edtdateorcontact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AdoptionDailyActivitiesActivity.this,
    ...
    /*    if (TextUtils.isEmpty(binding.edtprobleminlib.getText().toString().trim())) {
            GlobalClass.dailogError(AdoptionDailyActivitiesActivity.this, "problems Missing!", "Please type problems you are facing in Library.");

            return false;
        } else*/

        if (TextUtils.isEmpty(binding.edtdateorcontact.getText().toString().trim())) {
            GlobalClass.dailogError(AdoptionDailyActivitiesActivity.this, "Visited date Missing!", "Please select date on which you visited.");

            return false;

        } else if (TextUtils.isEmpty(binding.edtprobleminlib.getText().toString().trim())) {
            GlobalClass.dailogError(AdoptionDailyActivitiesActivity.this, "problems Missing!", "Please type problems you are facing.");

            return false;
        } /*else if (TextUtils.isEmpty(binding.edtsolutions.getText().toString().trim())) {
            GlobalClass.dailogError(AdoptionDailyActivitiesActivity.this, "Solution provided by student Missing!", "Please type solution provided by student.");

            return false;

        } else if (TextUtils.isEmpty(binding.edtrequiredment.getText().toString().trim())) {
            GlobalClass.dailogError(AdoptionDailyActivitiesActivity.this, "Requirement of person/orphans Missing!", "Please type solution provided by student.");

            return false;

        }*/ else if (imagefile == null) {
            // myLoaders.showSnackBar(view, "Please Enter Password");
            GlobalClass.dailogError(AdoptionDailyActivitiesActivity.this, "Image Missing!", "Please take a picture of your Activities.");
            return false;
        } else if (binding.lat.getText().toString().trim().isEmpty() && binding.longitude.getText().toString().trim().isEmpty()) {
            GlobalClass.dailogError(AdoptionDailyActivitiesActivity.this, "Location of your Activity is  Missing!", "Please make sure gps or location is Enable / ON of phone to get plant location.");
