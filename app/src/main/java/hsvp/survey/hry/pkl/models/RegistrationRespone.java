...
public class RegistrationRespone {
    ...
    public class Data {
        ...
        @Expose
        private List<NodalOfficer> nodalOfficers = new ArrayList<NodalOfficer>();
        @SerializedName("collegeSchemes")
        @Expose
        private List<CollegeScheme> collegeSchemes = new ArrayList<CollegeScheme>();
        @SerializedName("nodalOfficersSchemes")
        @Expose
        private List<NodalOfficersScheme> nodalOfficersSchemes = new ArrayList<NodalOfficersScheme>();
        ...
        public List<NodalOfficer> getNodalOfficers() {
            return nodalOfficers;
        }

        public void setNodalOfficers(List<NodalOfficer> nodalOfficers) {
            this.nodalOfficers = nodalOfficers;
        }

        public List<CollegeScheme> getCollegeSchemes() {
            return collegeSchemes;
        }

        public void setCollegeSchemes(List<CollegeScheme> collegeSchemes) {
            this.collegeSchemes = collegeSchemes;
        }

        public List<NodalOfficersScheme> getNodalOfficersSchemes() {
            return nodalOfficersSchemes;
        }

        public void setNodalOfficersSchemes(List<NodalOfficersScheme> nodalOfficersSchemes) {
