...
import hsvp.survey.hry.pkl.adapter.NodalSchemeTypesForverificationAdapter;
...
public class NodalSchemeTypeListForVerificationActivity extends BaseActivity implements NodalSchemeTypesAdapter.ItemListener, NodalSchemeTypesForverificationAdapter.ItemListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NodalSchemeTypesForverificationAdapter adaptermain = new NodalSchemeTypesForverificationAdapter(this, arrayList, this);
    ...
    public void onItemClick(OptionDataModel item, int currposition) {
        ...
        if (item.Id == 1) {
            ...
            if (CSPreferences.readString(this, "role").equalsIgnoreCase("3")) {
                ...
                if (studentStatus.equalsIgnoreCase("222")) {


                    Intent intent = new Intent(this, StudentVerificationListActivity.class);
                    intent.putExtra("schemeId", "1");
                    intent.putExtra("title", "Taking Care of old Age or Orphans");
                    startActivity(intent);
                } else {

                    Intent intent = new Intent(this, StudentVerifiedListForNodalActivity.class);
                    intent.putExtra("schemeId", "1");
                    intent.putExtra("title", "Taking Care of old Age or Orphans");
                    startActivity(intent);
    ...
    public void initData() {
        ...
        try {
            ...
            if (extras != null) {
                ...
                studentStatus = extras.getString("studentStatus");
