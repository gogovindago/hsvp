...
import hsvp.survey.hry.pkl.databinding.ActivityRuralOldAgedDailyActivitiesBinding;
...
public class RuralOldAgedDailyActivitiesActivity extends BaseActivity {
    ActivityRuralOldAgedDailyActivitiesBinding binding;
    String Description, ImageDate, Longitude, Latitude, currentDateandTime, time, TypeOfVisit="PhysicalVsit",
            accuracyvalue, COllegeID, token, User_Id, schemeId,
            takecarenodalOfficerId, userGender, ContactByPhone="No";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_rural_old_aged_daily_activities);
        ...
        btnRadiogroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int checkedId) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(RuralOldAgedDailyActivitiesActivity.this, checkedRadioButton.getText(), Toast.LENGTH_SHORT).show();
                }
    ...
    private void checkGPSStatus() {
        ...
        if (!gps_enabled && !network_enabled) {
            AlertDialog.Builder dialog = new AlertDialog.Builder(RuralOldAgedDailyActivitiesActivity.this);
    ...
    PermissionListener permissionListener = new PermissionListener() {
        ...
        public void onPermissionDenied(ArrayList<String> deniedPermissions) {
            checkpermissions(RuralOldAgedDailyActivitiesActivity.this);
...
//                        break;
    ...
    public void initData() {
        binding.toolbar.tvToolbarTitle.setText("Scheme C Daily Activity");
        ...
        try {
            ...
            takecarenodalOfficerId = CSPreferences.readString(this, "RuraltakecarenodalOfficerId");
    ...
    public void initListeners() {
        ...
        binding.txtAdoptedpersondetailedt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(RuralOldAgedDailyActivitiesActivity.this, ModificationInAdoptedPersonDetailActivity.class);
                startActivity(i);
        ...
        binding.btnRuralsubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (Check_Data(view)) {
...
longitude*/
                    ...
                    String problemfaced = binding.edtproblemfacedrural.getText().toString().trim();
                    ...
                    String activitiesOrganized = binding.edtruralprogorg.getText().toString().trim();
                    String dateorcontact = binding.edtdateorcontact.getText().toString().trim();
                    String anyotherorbservation = binding.edtruralotheractivityorg.getText().toString().trim();
/*String token,
...
Document*/
                    try {
                        ...
                        RequestBody activities_Organized = RequestBody.create(MediaType.parse("multipart/form-data"), activitiesOrganized);
                       ...
                       // RequestBody DateOfVisit = RequestBody.create(MediaType.parse("multipart/form-data"), "01/02/2020");
                        RequestBody ContactBy_Phone = null;
                        try {
                            ContactBy_Phone = RequestBody.create(MediaType.parse("multipart/form-data"), ContactByPhone);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        RequestBody TypeOf_Visit = null;
                        try {
                            TypeOf_Visit = RequestBody.create(MediaType.parse("multipart/form-data"), TypeOfVisit);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                       ...
                       // RequestBody uplodingTime = RequestBody.create(MediaType.parse("multipart/form-data"), "11:10");
                        ...
                        if (GlobalClass.isNetworkConnected(RuralOldAgedDailyActivitiesActivity.this)) {
                            WebAPiCall webapiCall = new WebAPiCall();
                            webapiCall.RuralTakecareStep2DataMethod(RuralOldAgedDailyActivitiesActivity.this, RuralOldAgedDailyActivitiesActivity.this, "Bearer " + token,
                                    StudentId,
                            ...
                            Toast.makeText(RuralOldAgedDailyActivitiesActivity.this, GlobalClass.nointernet, Toast.LENGTH_LONG).show();
                        }


                        ///  GlobalClass.dailogsuccessWithActivity(RuralOldAgedDailyActivitiesActivity.this, RuralOldAgedDailyActivitiesActivity.this, "Daily Activity Done", "Your Activity submitted successfully.");
       ...
       /* binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
        ...
        binding.edtdateorcontact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(RuralOldAgedDailyActivitiesActivity.this,
    ...
    public boolean Check_Data(View view) {
        ...
        if (TextUtils.isEmpty(binding.edtproblemfacedrural.getText().toString().trim())) {
            GlobalClass.dailogError(RuralOldAgedDailyActivitiesActivity.this, "problems Missing!", "Please type problems you are facing.");

            return false;
        } else if (TextUtils.isEmpty(binding.edtsolutions.getText().toString().trim())) {
            GlobalClass.dailogError(RuralOldAgedDailyActivitiesActivity.this, "Solution provided by student Missing!", "Please type solution provided by student.");

            return false;

        } /*else if (TextUtils.isEmpty(binding.edtrequiredment.getText().toString().trim())) {
            GlobalClass.dailogError(RuralOldAgedDailyActivitiesActivity.this, "Requirement of person/orphans Missing!", "Please type solution provided by student.");

            return false;

        }*/ else if (TextUtils.isEmpty(binding.edtdateorcontact.getText().toString().trim())) {
            GlobalClass.dailogError(RuralOldAgedDailyActivitiesActivity.this, "Visited date Missing!", "Please select date on which you visited.");

            return false;

        } else if (imagefile == null) {
            // myLoaders.showSnackBar(view, "Please Enter Password");
            GlobalClass.dailogError(RuralOldAgedDailyActivitiesActivity.this, "Image Missing!", "Please take a picture of your Activities.");
            return false;
        } else if (binding.lat.getText().toString().trim().isEmpty() && binding.longitude.getText().toString().trim().isEmpty()) {
            GlobalClass.dailogError(RuralOldAgedDailyActivitiesActivity.this, "Location of your Activity is  Missing!", "Please make sure gps or location is Enable / ON of phone to get plant location.");
