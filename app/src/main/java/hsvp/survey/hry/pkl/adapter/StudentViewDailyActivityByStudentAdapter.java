...
public class StudentViewDailyActivityByStudentAdapter extends RecyclerView.Adapter<StudentViewDailyActivityByStudentAdapter.ViewHolder> implements Filterable {
    ...
    public StudentViewDailyActivityByStudentAdapter(Context context, ArrayList values, String titleofitem, ItemListener itemListener) {
        title = titleofitem;
        mValues = values;
        newmValues = values;
        mContext = context;
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (StudentDailActivityForNodalofficerResponse.Datum row : mValues) {
                        ...
                        if (row.getDateOfVisit().toLowerCase().contains(charString.toLowerCase()) || row.getStudentId().contains(charSequence)) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public TextView
                texttypeOfVisitvalue,
                textdateOfVisitvalue,
                textView, txtschemeName, txtStudentnamevalue,
                txtstudentvalue, txtMobilevalue, txtDistrictvalue,
        ...
        public void setData(StudentDailActivityForNodalofficerResponse.Datum data, int currposition) {
            ...
            //  txtStudentnamevalue.setText(data.getFirstname() + " " + data.getLastname());
            ...
            // txtMobilevalue.setText(data.get());
    ...
    @Override
    public StudentViewDailyActivityByStudentAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(mContext).inflate(R.layout.student_self_daily_activity_row, parent, false);
